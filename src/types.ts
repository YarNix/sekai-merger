// Own types
export const ALL_MUSIC_DIFFICULTY = ["easy", "normal", "hard", "expert", "master", "append"] as const;
...
export type SectionItemTypes = ArrayElement<ServerItemInfo['sections']>['itemType'];
export type SectionItems = ArrayElement<ArrayElement<ServerItemInfo['sections']>['items']>;
/// Why didn't you make ServerItemInfo generic type instead of union Burrito
type TypedServerItemInfo<K extends SectionItemTypes, T extends SectionItems> =
Omit<ServerItemInfo, 'sections'> & {
  sections: ServerItemSectionTyped<K, T>[]
}
export type SonolusCollection<T extends SectionItems> = {
  info: TypedServerItemInfo<SectionItemTypes, T>,
  list: ServerItemList<T>,
  content?: Record<string, ServerItemDetails<T>>
}
export type SonolusCollectionPackage = {
  info: ServerInfo,
  package: PackageInfo,
  content: {
    backgrounds?: SonolusCollection<BackgroundItem>,
    effects?: SonolusCollection<EffectItem>,
    engines?: SonolusCollection<EngineItem>,
    levels?: SonolusCollection<LevelItem>,
    particles?: SonolusCollection<ParticleItem>,
    playlists?: SonolusCollection<PlaylistItem>,
    posts?: SonolusCollection<PostItem>,
    replays?: SonolusCollection<ReplayItem>,
    skins?: SonolusCollection<SkinItem>
  }
}
// Database types
